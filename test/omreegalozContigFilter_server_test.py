...
class omreegalozContigFilterTest(unittest.TestCase):
    ...
    # NOTE: According to Python unittest naming rules test method names should start from 'test'. # noqa
    def test_run_omreegalozContigFilter_ok(self):
    ...
    def test_run_omreegalozContigFilter_min_len_negative(self):
    ...
    def test_run_omreegalozContigFilter_min_len_parse(self):
